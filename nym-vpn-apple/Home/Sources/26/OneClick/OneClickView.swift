...
private extension OneClickView {
    var powerUserSection: some View {
        ...
        .padding(.horizontal, ByVpnSpacing.standard)
        .padding(.top, ByVpnSpacing.component)
        .padding(.bottom, ByVpnSpacing.medium)
    ...
    var baseSection: some View {
        ...
        .padding(.bottom, ByVpnSpacing.component)
    }
    ...
    var exitNodeLabel: some View {
        Text("oneClick.exitNode.label".localizedString)
            ...
            .padding(.bottom, animatedDisplayMode == .nerd ? ByVpnSpacing.small : 0)
    ...
    func selectingRowCompact(score: OneClickServerScore, supportsPostQuantum: Bool = false) -> some View {
        VStack(alignment: .leading, spacing: ByVpnSpacing.extraExtraSmall) {
            HStack(alignment: .center, spacing: ByVpnSpacing.medium) {
                ...
                if supportsPostQuantum {
                    Image(systemName: "atom")
                        .foregroundStyle(colorScheme == .dark ? Color.ByVpn.primary : Color.ByVpn.textPrimary)
            ...
            HStack(alignment: .center, spacing: ByVpnSpacing.medium) {
                ...
                HStack(spacing: ByVpnSpacing.extraSmall) {
    ...
    func scoreBars(score: OneClickServerScore) -> some View {
        Image(systemName: "cellularbars", variableValue: score.variableValue)
            ...
            .foregroundStyle(score.activeColor, Color.ByVpn.textTertiary.opacity(0.35))
    ...
    var upCaretView: some View {
        ...
        .foregroundStyle(Color.ByVpn.textTertiary)
    ...
    var connectButtonStyle: ByVpnButton.Style {
        switch viewModel.connectState {
