...
EXIT_SERVERS_FILE_NAME="../ByVPN/Resources/gatewaysExit.json"

ENTRY_SERVERS_URL="https://nymvpn.com/api/public/v1/directory/gateways/entry"
ENTRY_SERVERS_FILE_NAME="../ByVPN/Resources/gatewaysEntry.json"

VPN_SERVERS_URL="https://nymvpn.com/api/public/v1/directory/gateways?show_vpn_only=true"
VPN_SERVERS_FILE_NAME="../ByVPN/Resources/gatewaysVpn.json"
