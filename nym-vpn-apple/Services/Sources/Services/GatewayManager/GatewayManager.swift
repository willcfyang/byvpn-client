...
@MainActor public final class GatewayManager: ObservableObject {
    ...
    @Published public var entryCountries: [ByVpnCountry]
    @Published public var exitCountries: [ByVpnCountry]
    @Published public var vpnCountries: [ByVpnCountry]
    ...
    public func country(with code: String, gatewayType: NodeType) -> ByVpnCountry? {
    ...
    public func country(with gatewayId: String?, nodeType: NodeType) -> ByVpnCountry? {
...
extension GatewayManager {
    ...
    public func localizedCountry(with countryCode: String?) -> ByVpnCountry? {
        ...
        return ByVpnCountry(name: countryName, code: countryCode, regions: [])
    }
}
...
private extension GatewayManager {
    ...
    func localizeAndSortCountries(_ countries: [ByVpnCountry]) -> [ByVpnCountry] {
        var localized = countries.compactMap { country -> ByVpnCountry? in
