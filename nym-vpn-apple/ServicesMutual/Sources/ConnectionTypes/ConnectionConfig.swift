...
public struct ConnectionConfig: Codable {
    ...
    public var gatewaySelectionAlgorithmConfig: ByVpnGatewaySelectionAlgorithmConfig
    ...
    public init(
        ...
        gatewaySelectionAlgorithmConfig: ByVpnGatewaySelectionAlgorithmConfig = ByVpnGatewaySelectionAlgorithmConfig(enableGeoLocation: true, algorithm: .auto)
    ) {
        self.entry = entry
        self.exit = exit
        self.dns = dns
    ...
    public init(from config: VpnServiceConfig) {
        ...
        self.gatewaySelectionAlgorithmConfig = ByVpnGatewaySelectionAlgorithmConfig(
...
extension ConnectionConfig {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.gatewaySelectionAlgorithmConfig = try container.decodeIfPresent(
            ByVpnGatewaySelectionAlgorithmConfig.self,
            forKey: .gatewaySelectionAlgorithmConfig
        ) ?? ByVpnGatewaySelectionAlgorithmConfig(enableGeoLocation: true, algorithm: .auto)
    }
}
