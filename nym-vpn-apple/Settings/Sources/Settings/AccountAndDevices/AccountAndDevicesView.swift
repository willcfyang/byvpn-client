...
extension AccountAndDevicesView {
    ...
    @ViewBuilder
    func byVpnAccountSection() -> some View {
        VStack(spacing: 0) {
            if isLinkAccountAvailable {
                ...
                SettingsListItem(
                    viewModel: SettingsListItemViewModel(
                        ...
                        title: "settings.account.byVpnAccount".localizedString,
    ...
    func accountSubtitle() -> String? {
        ...
        return accountSummary.isLinked ? nil : "settings.account.byVpnAccount.subtitle".localizedString
    }
    ...
    func manageSubscriptionSubtitle() -> AttributedString? {
        ...
        if accountSummary?.subscription?.status == .pending {
            ...
            confirmingPayment.foregroundColor = Color.ByVpn.error
    ...
    func byVpnLinkingText() -> some View {
        HStack(spacing: 0) {
            Text(linkingTitle())
    ...
    func linkingTitle() -> String {
        ...
        ? "⚡️ \("settings.account.byVpnAccount.linked.subtitle".localizedString)"
