...
final class AutologinState {
    ...
    func start(kind: ByVpnDeeplinkKind, using credentialsManager: CredentialsManager) {
        isLoading = true
        task = Task {
    ...
    func perform(kind: ByVpnDeeplinkKind, using credentialsManager: CredentialsManager) async {
        do {
