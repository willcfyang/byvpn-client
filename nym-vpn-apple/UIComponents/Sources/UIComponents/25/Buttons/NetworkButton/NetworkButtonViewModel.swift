...
@MainActor public final class NetworkButtonViewModel: ObservableObject {
    ...
    @Published var selectionImageColor: Color = ByVpnColor.gray1
    ...
    func updateUI(isSelected: Bool) {
        selectionImageColor = isSelected ? ByVpnColor.action : ByVpnColor.gray1
        selectionStrokeColor = isSelected ? ByVpnColor.action : .clear
