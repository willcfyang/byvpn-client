...
public struct StrokeBorderView<Content: View>: View {
    ...
    public init(
        ...
        strokeColor: Color = ByVpnColor.gray2,
        backgroundColor: Color = ByVpnColor.background,
        backgroundColorHover: Color = ByVpnColor.backgroundHover,
    ...
    public var body: some View {
        ...
        .overlay(alignment: .topLeading) {
            HStack {
                Text(strokeTitle)
                    .foregroundStyle(ByVpnColor.primary)
