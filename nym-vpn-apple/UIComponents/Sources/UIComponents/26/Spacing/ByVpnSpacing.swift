...
/// Spacing constants drawn from the ByVPN Figma design system.
///
/// Usage: `.padding(ByVpnSpacing.section)` or `.padding(.horizontal, ByVpnSpacing.component)`
public enum ByVpnSpacing {
